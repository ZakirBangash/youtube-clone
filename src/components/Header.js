  ...
  return (
    <header className="header">
      ...
      <div className="header__right">
        <Tooltip className="header__icon" title="Create" aria-label="Search">
          <VideoCallIcon />
        </Tooltip>

        <Tooltip className="header__icon" title="Youtube apps" aria-label="Search">
         <AppsIcon />
        </Tooltip>

        <Tooltip className="header__icon" title="Notifications" aria-label="Search">
         <NotificationsIcon />
        </Tooltip>
         
        <Avatar  className="header__icon" alt="Zakir"  src="" />
